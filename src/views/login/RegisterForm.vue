<template>
  <van-form v-if="getShow" ref="formRef" class="flex flex-col" @submit="handleRegister">
    <van-cell-group inset class="enter-y !mx-0 !mb-10">
      <van-field v-model="formData.username" class="enter-y items-center !rounded-md" name="username" placeholder="用户名"
      ...
      <van-field v-model="formData.mobile" class="enter-y items-center !rounded-md" name="password" placeholder="手机号码"
      ...
      <van-field v-model="formData.sms" class="enter-y items-center !rounded-md" center clearable placeholder="请输入短信验证码"
      ...
      <van-field v-model="formData.password" class="enter-y items-center !rounded-md"
      ...
      <van-field v-model="formData.confirmPassword" class="enter-y items-center !rounded-md"
    ...
    <van-button class="enter-y !rounded-md" plain type="primary" block @click="handleBackLogin">
      返 回
    </van-button>
  </van-form>
</template>
