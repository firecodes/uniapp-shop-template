...
<template>
	<view
		...
		<view class="flex items-center">
			<radio style="transform: scale(0.9)" :disabled="cartList.length == 0" color="#fbb957" :checked="isSelectedAll"
		...
		<view class="text-white bg-[#fbb957] px-6 py-1.5 rounded-full text-sm" :class="{ 'opacity-50': selectedCount == 0 }"
