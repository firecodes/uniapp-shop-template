<template>
  <div>
    ...
    <div class="my-card relative mx-6 flex flex-col items-center rounded-2xl pb-2 shadow-xl -top-18">
      <van-image class="h-22 w-22 border-2 border-solid !absolute -top-10" round fit="cover" :src="avatar" />
      ...
      <van-action-sheet v-model:show="showLogoutAction" teleport="body" :actions="logoutActions" cancel-text="取消"
        description="确认退出登录吗" close-on-click-action />
    </div>
  </div>
</template>
