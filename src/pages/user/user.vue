...
import { onLaunch, onShow, onHide, onNavigationBarSearchInputClicked, onNavigationBarButtonTap } from '@dcloudio/uni-app';

import listCell from '@/components/mix-list-cell/index.vue';
    ...
    <view class="container">
        <view class="user-section">
            ...
            <view class="user-info-box">
                <view class="portrait-box" @click="navTo('/pages/login/login')">
